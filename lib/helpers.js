...
helpers.loadConfigFile = function (configPath) {
  var configDir = './config/',
      fileDir = helpers.getDirname(configPath),
      fileName = helpers.getBasename(configPath),
      fileExtension = helpers.getExtname(fileName),
      filePath = path.join(__dirname, configDir + fileDir, fileName),
...
helpers.getBasename = function (filePath) {
  return path.basename(filePath);
};

helpers.getDirname = function (filePath) {
  return path.dirname(filePath);
};

helpers.getExtname = function (filePath) {
