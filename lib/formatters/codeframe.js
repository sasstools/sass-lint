 ...
 */
const formatFilePath = function (filePath, line, column) {
 ...
 */
const formatMessage = function (message, parentResult) {
 ...
 */
const formatSummary = function (errors, warnings, fixableErrors, fixableWarnings) {
