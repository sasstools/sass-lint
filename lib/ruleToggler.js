...
var addDisableBlock = function (toggledRules, rules, blockChild) {
  ...
  rules.map(function (rule) {
    toggledRules.ruleEnable[rule] = toggledRules.ruleEnable[rule] || [];
    toggledRules.ruleEnable[rule].push([false, blockBounds.start.line, blockBounds.start.column]);
    toggledRules.ruleEnable[rule].push([true, blockBounds.end.line, blockBounds.end.column]);
  });
};
