...
var compiledCSSDoesNotCreateDepth = function (selector) {
  return lodash.isArray(selector.content) &&
    lodash.isArray(selector.content[0].content) &&
    selector.content[0].content[0] === '&';
          ...
          if (block.contains('ruleset')) {
            block.forEach('ruleset', function (ruleset) {
              ruleset.forEach('selector', function (selector) {
                ...
                if (compiledCSSDoesNotCreateDepth(selector)) {
                  return;
                }
